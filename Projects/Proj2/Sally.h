...
private:
  ...
  static void doECL(Sally *Sptr);

  static void doLessTh(Sally *Sptr);
  static void doLessThE(Sally *Sptr);
  static void doEE(Sally *Sptr);
  static void doNotE(Sally *Sptr);
  static void doGreatTh(Sally *Sptr);
  static void doGreatThE(Sally *Sptr);
